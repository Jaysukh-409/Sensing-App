...
import 'package:sensing_app/Screens/surveyscreen5.dart';

class Survey4Screen extends StatefulWidget {
  List<int> answer;
  Survey4Screen({required this.answer, super.key});

  @override
  State<Survey4Screen> createState() => _Survey4ScreenState();
}
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Center(
                child: Text(
                  "Q. If you have to take a break, how long do you need to recover after you have worked 'until you drop' or are no longer able to concentrate on what you are doing?",
                  style: TextStyle(
